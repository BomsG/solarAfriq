    ...
    <div className="container mx-auto ">
      ...
      <div className='text-center mt-[100px] px-20'>
        ...
        <h2 className="text-[16px] ">
          Explore our range of high-quality solar products designed to  help you harness the power of the sun. <br /> From efficient solar panels and inverters to complete solar power kits and storage batteries, <br /> we offer solutions tailored to residential, commercial, and industrial needs.
        </h2>
      </div>
          ...
          <div key={product.id} className=" rounded-lg  shadow-lg">
            ...
            <div className='p-4'>
              ...
              <button
                ...
                onClick={() => addToCart(product)} // Use context's addToCart
              >
                Add to Cart
              </button>
            </div>
